...
if [ "$1" == "up" ]; then
    if [ $2 == 1 ]; then
        ...
        cd ./modbus-ctf/1\ -\ My\ First\ Modbus
    ...
    if [ $2 == 3 ]; then
        ...
        cd ./modbus-ctf/3\ -\ Anyone\ Can\ Write
    ...
    if [ $2 == 4 ]; then
        ...
        cd ./modbus-ctf/4\ -\ What\'s this device
